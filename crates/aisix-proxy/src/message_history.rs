...
#[async_trait]
pub trait MessageHistoryStorage: Send + Sync + 'static {
...
pub enum StoredMessageHistoryStatus {
    #[default]
    Completed,
    Failed,
}
...
pub struct StoredMessageHistory {
...
pub struct InMemoryMessageHistoryStorage {
