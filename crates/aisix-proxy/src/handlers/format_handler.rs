...
use aisix_guardrail::traits::{GuardrailCheckPayload, GuardrailOutcome};
use crate::{
    AppState,
    guardrails::{
...
fn has_output_guardrails(guardrails: &[Box<dyn ResolvedGuardrail>]) -> bool {
    guardrails
        .iter()
        .any(|guardrail| guardrail.supports_stage(aisix_guardrail::traits::GuardrailStage::Output))
}
...
mod tests {
    ...
    use aisix_guardrail::traits::{GuardrailCheckPayload, OutputGuardrailPayload};
