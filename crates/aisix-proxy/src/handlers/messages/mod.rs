...
use aisix_llm::{
    ...
    types::{
        anthropic::{
            ...
            AnthropicMessagesResponse, AnthropicStreamEvent, ImageSource, SystemBlock, SystemPrompt,
        },
        common::Usage,
...
fn rewrite_anthropic_request_messages(
    ...
    messages: &[aisix_llm::types::openai::ChatMessage],
) -> Result<(), GatewayError> {
...
fn chat_message_to_anthropic_message(
    message: &aisix_llm::types::openai::ChatMessage,
...
fn anthropic_response_to_chat_message(
...
) -> Result<aisix_llm::types::openai::ChatMessage, GatewayError> {
    ...
    Ok(aisix_llm::types::openai::ChatMessage {
