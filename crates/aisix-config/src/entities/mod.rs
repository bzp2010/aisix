...
use crate::{ConfigEvent, ConfigProvider, GetEntry};
...
mod tests {
    ...
    use super::*;
    use crate::{ConfigEvent, ConfigEventReceiver, GetEntry, PutEntry};
    ...
    #[async_trait]
    impl crate::ConfigProvider for MockProvider {
